...
INSERT INTO Event1(name,date1,venue,category, description) VALUES ("Loolapalooza", '2018-05-20', 1, "Music", "A famous music festival"), ("Super Bowl 2020", '2020-05-14',2,  "Sport", "A football match"), ("El Clasico", '2019-06-27',1, "Sport", "A football match");
...
INSERT INTO Competes(team, competition, win,season) VALUES (1,1,1, "2021-2022"), (1,2,1,"1999-2000"),(2,3,1, "2021-2022");
...
INSERT INTO Section(course) VALUES (1),(1),(3);
INSERT INTO Enrolls(student, section,semester,grade) VALUES (1,1,1, NULL), (2,1,2,"A"), (3,2,3, "C+");
...
INSERT INTO Gym(name, capacity, sports_facilities) VALUES ("David LLoyd Club", 0, "Tennis court, Football field, Swimming pool"), ("Mashouf Wellness Center", 1, "Weight room, Basketball Court"), ("PhisiCool", 50, "Yoga room, Track and Field, Voleyball");
...
INSERT INTO Match1(team1,team2,date1,competition,venue) VALUES (1,2,'2022-12-01',1,1),(2,3,'2021-05-22', 1,1), (1,2, '2023-01-12',2,2),(1,2,'2020-01-12',1,1);
...
INSERT INTO Takes(section, class) VALUES (1,1),(2,1),(3,3),(1,2),(1,3),(2,2);
